...
SELECT
    ...
    (p.product_type = 'fixed_asset') AS is_fixed_asset_purchase,
    ...
    CASE WHEN p.product_type = 'fixed_asset' THEN d.amount - d.tax_amount ELSE NULL END AS asset_taxable_amount,
    CASE WHEN p.product_type = 'fixed_asset' THEN d.tax_amount ELSE NULL END AS asset_tax_amount,
    CASE WHEN p.product_type != 'fixed_asset' OR p.product_type IS NULL THEN d.amount - d.tax_amount ELSE NULL END AS regular_taxable_amount,
    CASE WHEN p.product_type != 'fixed_asset' OR p.product_type IS NULL THEN d.tax_amount ELSE NULL END AS regular_tax_amount
