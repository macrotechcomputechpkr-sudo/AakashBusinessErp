...
export default function SalesAdditionalEntry() {
    ...
    return (
        ...
        {auditModal && <RecordHistory table="sales_additional_entries" id={auditModal.id} title={auditModal.doc_no} legacyUrl={`/api/sales-additional-entries/${auditModal.id}/audit-trail`} onClose={() => setAuditModal(null)} />}
        </div>
        </Layout>
    );
}
